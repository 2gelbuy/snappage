...
declare module '#imports' {
  ...
  export { MAX_PAGE_HEIGHT, MAX_CAPTURE_TILES, SCROLL_SETTLE_DELAY, CAPTURE_DELAY, FILENAME_MAX_LENGTH, FILENAME_SANITIZE_REGEX } from '../utils/constants';
  export { CaptureMode, ImageFormat, OutputFormat, StartCaptureMessage, CaptureProgressMessage, CaptureCompleteMessage, CaptureErrorMessage, StitchImagesMessage, StitchResultMessage, StitchErrorMessage, PopupToBackground, BackgroundToPopup, BackgroundToOffscreen, OffscreenToBackground, Message } from '../utils/messages';
  export { sanitizeFilename, buildFilename } from '../utils/sanitize';
}
